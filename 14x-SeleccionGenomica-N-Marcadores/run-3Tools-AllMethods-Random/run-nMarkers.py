...
nMarkersList = [100, 1000, 2000, 3000, 4000, 4641]
...
def main ():
	...
	createRunningDir (runsDir, nMarkersDirs)

	runMultipleGS (runsDir, nMarkersDirs)
...
#--------------------------------------------------------------------
#--------------------------------------------------------------------
def createRunningDir (runsDir, nMarkersDirs):
	for nDir in nMarkersDirs:
		ymlLines = open ("template_ConfigFile.yml").readlines ()
...
#--------------------------------------------------------------------
#--------------------------------------------------------------------
def runMultipleGS (inputDir, nMarkersDirs):
