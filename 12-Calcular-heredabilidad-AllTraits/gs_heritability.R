...
main <-  function() {
    ...
    phenotypesFile   = "inputs/fenotiposColor-ComponentesLCH.csv"
    genotypeFile     = "inputs/genotipo-AndigenaCCC-ClusterCall2020-MATRIX.csv"
    outputDir        = "outputs"
...
gs_heritability <- function (genoFile, phenosFile, outputDir) {
	...
	h2Results = mclapply (traitNames, calculateHeritabilityTrait, 
						  geno, pheno, outputDir, mc.cores=3)
...
old_calculateHeritabilityTrait <- function (traitName, geno, pheno, outputDir) {
